...
def preprocess_cifar10_data(
    X_train_raw, Y_train_raw, X_test_raw, Y_test_raw, unit_variance=False
):
    """
...
class DataSet(object):
    ...
    def __init__(self, images, labels):
        ...
        ), "images.shape: {0}, labels.shape: {1}".format(
            str(images.shape), str(labels.shape)
        )
...
def read_data_sets(
    data_dir, one_hot=True, validation_size=0, unit_variance=False
):
    """
...
def get_cifar10(
    ...
    Returns:
      Dictionary with Train, Validation, Test Datasets
    """
    return read_data_sets(data_dir, one_hot, validation_size, unit_variance)
